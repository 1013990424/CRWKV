...
## Acknowledgements
The codes are based on [URWKV](https://github.com/FZU-N/URWKV) and [FreqMamba](https://github.com/aSleepyTree/FreqMamba). Please also follow their licenses. Thanks for their awesome works.
